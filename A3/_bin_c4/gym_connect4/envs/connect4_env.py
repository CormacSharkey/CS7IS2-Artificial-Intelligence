...
class Connect4:
    ...
    def is_potential_winner(self, player: int = None, neighbours: int = 0) -> bool:
        """Evaluate board, find out if a player has almost won. Varies with neighbours
        ...
        for d in self.win_conditions:
            ...
            for i in range(1, self.win_length-neighbours):
